            ...
            <div class="col-md-8 col-md-offset-1">
                <div class="jumbotron">
                    <div class="panel-heading">
                        <h3>                        
                           {{trans('text.titleEditAward')}}
                        </h3>
                        <h5>{{trans('text.requiredC')}}</h5>
                    </div>
        
                    <div class="panel-body">   
                        {!! Form::open(['route'=>['adm.users.update', $awards[0]->id_user], 'method'=>'PUT', 'class'=>'form-horizontal']) !!}         			
                                ...
                                @foreach ($awards as $award)                                   
                                    ...
                                    <div class="container-fluid new">  
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="description[]" class="form-control"  required id="{{trans('text.description')}}" pattern="[A-Za-z0-9ñÑáéíóúÁÉÍÓÚ\s#.-°]{12,200}" title="{{trans('text.title-description')}}">{{ $award->description }}</textarea>                                   
                                        </div>
                                    </div><!--container-fluid-->
                                @endforeach
                            </div><!--copy-->
                            <input type="hidden" name="update" value="award">
                            <div class="target">
                                <h5>{{trans('text.addAward')}}<a href="{{ route('adm.users.add', [$awards[0]->id_user, 'award']) }}" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> </a></h5>
                            </div> 
